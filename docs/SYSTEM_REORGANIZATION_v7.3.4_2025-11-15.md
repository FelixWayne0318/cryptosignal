...
**发现**: 初次版本统一后发现部分核心文档仍有旧版本引用

**修复文件**:
1. **README.md** (5处)
   - v7.3.2-Full → v7.3.4 (标题描述)
   - v6.7 P2.2 → v7.3.4 (权重配置、注意事项、底部)
   - 更新分支名称到当前分支

2. **standards/00_INDEX.md**
   - 当前版本: v7.3.2 → v7.3.4

3. **standards/01_SYSTEM_OVERVIEW.md**
   - 版本: v7.3.2 → v7.3.4
   - 因子系统架构: v7.3.2 → v7.3.4

4. **standards/02_ARCHITECTURE.md**
   - 文档标题: v7.3.2 → v7.3.4
   - 项目概述: v7.3.2 → v7.3.4

5. **tests/integration_basic.sh**
   - 注释: v7.3.2 → v7.3.4

6. **scripts/realtime_signal_scanner.py**
   - 全部 v7.3.2-Full → v7.3.4 (replace_all)

7. **docs/FACTOR_SYSTEM_COMPLETE_DESIGN.md**
   - 文档标题和版本声明: v7.3.2-Full → v7.3.4

**提交记录**:
- Commit 1: `4fb9b3a` - README.md 剩余版本号统一
- Commit 2: `b20d866` - 核心文档和脚本版本统一

**说明**:
- 用户面向文档现已100%统一到 v7.3.4
- 代码注释中的历史版本标记(如"introduced in v7.3.2")保留作为技术文档
- 详细设计文档中的版本历史引用保留用于追溯功能演进

### Git提交摘要

**总计3次提交**:
1. `be3999b` - 系统整理 v7.3.4（主要版本统一 + 清理）
2. `4fb9b3a` - README.md 补充修复
3. `b20d866` - 核心文档补充修复
